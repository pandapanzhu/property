...
import { IStuff, Stuff } from 'app/shared/model/stuff.model';
...
describe('Service Tests', () => {
    describe('Stuff Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(StuffService);
            httpMock = injector.get(HttpTestingController);
            currentDate = moment();

            elemDefault = new Stuff(
                0,
                'AAAAAAA',
                'AAAAAAA',
                'AAAAAAA',
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Stuff', async () => {
                const returnedFromService = Object.assign(
                    {
                        userId: 'BBBBBB',
                        stuffname: 'BBBBBB',
