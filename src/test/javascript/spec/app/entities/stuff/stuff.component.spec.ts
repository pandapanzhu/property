    ...
    describe('Stuff Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(StuffComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.stuffs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
